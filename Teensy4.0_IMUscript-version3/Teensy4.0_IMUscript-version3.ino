...
float NVM_PAR_T1_val;
float NVM_PAR_T2_val;
float NVM_PAR_T3_val;
float NVM_PAR_P1_val;
float NVM_PAR_P2_val;
float NVM_PAR_P3_val;
float NVM_PAR_P4_val;
float NVM_PAR_P5_val;
float NVM_PAR_P6_val;
float NVM_PAR_P7_val;
float NVM_PAR_P8_val;
float NVM_PAR_P9_val;  
float NVM_PAR_P10_val;
float NVM_PAR_P11_val;
...
//        writeTo(BM388_ADDRESS,CONFIG, 0b);      // IIR filter coefficient of 4
        ...
        NVM_PAR_T1_val = (uint16_t)(buff_calib[0] | (buff_calib[1] << 8)); 
        NVM_PAR_T2_val = (uint16_t)(buff_calib[2] | (buff_calib[3] << 8)); 
        NVM_PAR_T3_val = (int8_t)buff_calib[4]; 
        NVM_PAR_P1_val = (int16_t)(buff_calib[5] | (buff_calib[6] << 8)); 
        NVM_PAR_P2_val = (int16_t)(buff_calib[7] | (buff_calib[8] << 8)); 
        NVM_PAR_P3_val = (int8_t)buff_calib[9]; 
        NVM_PAR_P4_val = (int8_t)buff_calib[10]; 
        NVM_PAR_P5_val = (uint16_t)(buff_calib[11] | (buff_calib[12] << 8)); 
        NVM_PAR_P6_val = (uint16_t)(buff_calib[13] | (buff_calib[14] << 8)); 
        NVM_PAR_P7_val = (int8_t)buff_calib[15]; 
        NVM_PAR_P8_val = (int8_t)buff_calib[16]; 
        NVM_PAR_P9_val = (int16_t)(buff_calib[17] | (buff_calib[18] << 8)); 
        NVM_PAR_P10_val = (int8_t)buff_calib[19]; 
        NVM_PAR_P11_val = (int8_t)buff_calib[20]; 
...
//        Serial.print(NVM_PAR_P1_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P2_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P3_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P4_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P5_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P6_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P7_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P8_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P9_val);
//        Serial.print(",");
//        Serial.print(NVM_PAR_P10_val);
//        Serial.print(",");
//        Serial.println(NVM_PAR_P11_val);
...
//  float AccXraw = (accRaw[0]* 0.061)/1000;
//  float AccYraw = (accRaw[1]* 0.061)/1000;
//  float AccZraw = (accRaw[2]* 0.061)/1000;

//  //Convert Accel raw to G's when FS is +/- 4g
//  float AccXraw = (accRaw[0]* 0.122)/1000;
//  float AccYraw = (accRaw[1]* 0.122)/1000;
//  float AccZraw = (accRaw[2]* 0.122)/1000;
...
//  float AccXraw = (accRaw[0]* 0.488)/1000;
//  float AccYraw = (accRaw[1]* 0.488)/1000;
//  float AccZraw = (accRaw[2]* 0.488)/1000;
  ...
  float comp_temp = temp_compensation(tempRaw);
...
//Used for Accelerometer,Gyroscope, and Magnetometer
